...
#' @param x numeric vector of x values
#' @param y numeric vector of y values
#' @param mst minimum spanning tree generated by igraph
#' @param sc scree object
#'
#' @examples
#'   require(ggplot2)
#'   require(dplyr)
